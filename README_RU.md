...
<p align="center">
  ...
  | <a target="_blank" href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FStevenkingx%2Faudiocore&env=SUNO_COOKIE,TWOCAPTCHA_KEY,BROWSER,BROWSER_GHOST_CURSOR,BROWSER_LOCALE,BROWSER_HEADLESS&project-name=audiocore&repository-name=audiocore">Развёртывание на Vercel</a> 
</p>
<p align="center">
...
![Баннер audiocore](https://github.com/Stevenkingx/audiocore/blob/main/public/suno-banner.png)
...
![Видеоинструкция о том, как получить куки](https://github.com/Stevenkingx/audiocore/blob/main/public/get-cookie-demo.gif)
...
> [!TIP]
> Если вы хотите получать как можно меньше капч, рекомендуется использовать macOS. Системы на macOS обычно получают меньше капч, чем Linux и Windows — это связано с их непопулярностью в сфере веб-скрейпинга. Запуск audiocore на Windows и Linux будет работать, но в некоторых случаях вы можете получить довольно большое количество капч.
...
[![Развёртывание на Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FStevenkingx%2Faudiocore&env=SUNO_COOKIE,TWOCAPTCHA_KEY,BROWSER,BROWSER_GHOST_CURSOR,BROWSER_LOCALE,BROWSER_HEADLESS&project-name=audiocore&repository-name=audiocore)
...
### 4. Настройте audiocore

- Если вы используете Vercel, настройте переменные среды в панели управления Vercel.

- Если вы установили audiocore локально, добавьте следующее в ваш `.env`-файл:
...
Вы можете посмотреть документацию audiocore здесь:
[suno.gcui.ai/docs](https://suno.gcui.ai/docs)

## Справочник по API

На данный момент audiocore реализует следующие API:
...
# замените на URL-адрес вашего audiocore
...
2. Создавайте [issue](https://github.com/Stevenkingx/audiocore/issues): мы ценим разумные предложения и сообщения об ошибках.
...
Мы используем [Issues на GitHub](https://github.com/Stevenkingx/audiocore/issues) для обратной связи. Не стестняйтесь создавать issue, мы оперативно решим вашу проблему.
...
- Репозиторий проекта: [github.com/Stevenkingx/audiocore](https://github.com/Stevenkingx/audiocore)
- Официальный сайт Suno.ai: [suno.ai](https://suno.ai)
- Демо: [suno.gcui.ai](https://suno.gcui.ai)
- [Readpo](https://readpo.com?utm_source=github&utm_medium=audiocore): ReadPo — это помощник для чтения и письма, работающий на основе искусственного интеллекта. Собирайте, курируйте и создавайте контент с молниеносной скоростью.
- Album AI: [Автоматическое создание метаданных изображения и общение с альбомом. RAG + Альбом.](https://github.com/Stevenkingx/album-ai)

## Заявление

audiocore — это неофициальный проект с открытым исходным кодом, предназначенный только для учебных и исследовательских целей.